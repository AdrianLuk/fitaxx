...
<?php if( get_theme_mod('wpforge_nav_select') == 'offcanvas') { ?>
  	...
  	<?php if( get_theme_mod( 'wpforge_mobile_position','left' ) == 'left') { ?>
		<div class="title-bar">
			<div class="title-bar-right">
                <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><img src="https://almojuela.com/fitaxxmeals/wp-content/themes/fitaxxmeals/images/logo/FitaxxMeals-Logo.svg" style="height: 50px !important; width: auto; float: left;"></a>
	...
	<?php } // end if ?>
  	...
  	<?php if( get_theme_mod( 'wpforge_mobile_position' ) == 'right') { ?>
		<div class="title-bar">
			<div class="title-bar-right">
                <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><img src="https://almojuela.com/fitaxxmeals/wp-content/themes/fitaxxmeals/images/logo/FitaxxMeals-Logo.svg" style="height: 50px; width: auto; float: left;"></a>
				<span class="title-bar-title"><?php echo get_theme_mod( 'wpforge_off_canvas_text','Menu' ); ?></span>
