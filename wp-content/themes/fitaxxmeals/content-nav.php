<div itemtype="http://schema.org/SiteNavigationElement" itemscope="itemscope" class="nav_container">
  ...
  <?php if( get_theme_mod( 'wpforge_nav_position' ) == 'scroll') { ?>
    ...
    <div class="top-bar" id="main-menu">
      ...
      <div class="top-bar-title">
          <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><img src="https://almojuela.com/fitaxxmeals/wp-content/themes/fitaxxmeals/images/logo/FitaxxMeals-Logo.svg" style="height: 100px; width: auto;"></a>
  ...
  <?php if( get_theme_mod( 'wpforge_nav_position' ) == 'fixed') { ?>
    ...
    <?php } // end if ?>
        <div class="title-bar" data-responsive-toggle="main-menu" data-hide-for="medium">
            <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><img src="https://almojuela.com/fitaxxmeals/wp-content/themes/fitaxxmeals/images/logo/FitaxxMeals-Logo.svg" style="height: 60px; width: auto; padding: 1% 0;"></a>
          <button class="menu-icon" type="button" data-toggle="main-menu" ></button>
